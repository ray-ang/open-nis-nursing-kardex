...
function rja_single_room_content()
{
	...
	if ( get_post_type() == 'room' && ( current_user_can('administrator') || current_user_can('nurse') || current_user_can('nurse_admin') ) ) {
		...
		<?php
	} elseif ( get_post_type() == 'room' && ( ! current_user_can('administrator') || ! current_user_can('nurse') || ! current_user_can('nurse_admin') ) ) {
		?>
